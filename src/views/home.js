...
import ToolCardVerbessern from '../components/tool-card-verbessern'
import ToolCardZutaten from '../components/tool-card-zutaten'
import './home.css'
  ...
  return (
    <div className="home-container">
      ...
      <div className="home-hero">
        ...
        <button className="home-button button">Rezept erstellen</button>
      </div>
      <div className="home-steps">
        <h1 className="home-text02">So funktioniert es!</h1>
        ...
        <div className="home-container01">
          <div className="home-step">
            ...
            <div className="home-container04">
              <h1 className="home-text06">Job auswählen</h1>
          ...
          <div className="home-step1">
            ...
            <div className="home-container07">
              <h1 className="home-text10">Textfeld ausfüllen</h1>
          ...
          <div className="home-step2">
            ...
            <div className="home-container10">
              <h1 className="home-text14">Rezept Online angucken</h1>
          ...
          <div className="home-step3">
            ...
            <div className="home-container13">
              <h1 className="home-text18">E-Mail bekommen</h1>
      ...
      <div className="home-blog">
        ...
        <div className="home-container15">
          <ToolCardZutaten rootClassName="tool-card-zutaten-root-class-name"></ToolCardZutaten>
        </div>
      </div>
      <div className="home-gallery">
        ...
        <div className="home-container22">
          <div className="home-container23">
            <h1 className="home-text31">Project Title</h1>
        ...
        <div className="home-container24">
          <div className="home-container25">
            <h1 className="home-text34">Project Title</h1>
        ...
        <div className="home-container26">
          <div className="home-container27">
            <h1 className="home-text37">Project Title</h1>
      ...
      <div className="home-stats">
        <div className="home-stat">
          <svg viewBox="0 0 1152 1024" className="home-icon09">
          ...
          <span className="home-text40">Customers</span>
        ...
        <div className="home-stat1">
          ...
          <span className="home-text44">Projects</span>
        ...
        <div className="home-stat2">
          ...
          <span className="home-text48">Cities</span>
          ...
          <div className="home-links-container">
            <div className="home-container29">
              <div className="home-product-container">
                ...
                <span className="home-text61">Tutorials</span>
                <span>Releases</span>
              </div>
              <div className="home-company-container">
                <span className="home-text63">Company</span>
                <span className="home-text64">About</span>
                <span className="home-text65">Careers</span>
                <span className="home-text66">Contact</span>
                <span>Blog</span>
              </div>
            </div>
            <div className="home-container30">
              <div className="home-contact">
                ...
                <span className="home-text69">hello@teleporthq.io</span>
                <span>+123 (4567) 890</span>
              </div>
              <div className="home-socials">
                <span className="home-text71">Follow Us</span>
